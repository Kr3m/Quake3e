...
/* Define to 1 if you have the `gnutls_certificate_set_retrieve_function2'
   function. */
#define HAVE_GNUTLS_CERTIFICATE_SET_RETRIEVE_FUNCTION2 1
...
#define HAVE_GNUTLS_PRIVKEY_IMPORT_EXT 1

/* Define to 1 if you have the `gnutls_session_get_data2' function. */
#define HAVE_GNUTLS_SESSION_GET_DATA2 1

/* Define to 1 if you have the `gnutls_x509_crt_equals' function. */
#define HAVE_GNUTLS_X509_CRT_EQUALS 1

/* Define to 1 if you have the `gnutls_x509_crt_sign2' function. */
#define HAVE_GNUTLS_X509_CRT_SIGN2 1

/* Define to 1 if you have the `gnutls_x509_dn_get_rdn_ava' function. */
#define HAVE_GNUTLS_X509_DN_GET_RDN_AVA 1

/* Define if GSSAPI support is enabled */
/* #undef HAVE_GSSAPI */ /* disabled for Quake3e - not needed for pak downloads */

/* Define to 1 if you have the <gssapi/gssapi_generic.h> header file. */
/* #undef HAVE_GSSAPI_GSSAPI_GENERIC_H */ /* disabled for Quake3e */

/* Define to 1 if you have the <gssapi/gssapi.h> header file. */
/* #undef HAVE_GSSAPI_GSSAPI_H */ /* disabled for Quake3e */

/* Define to 1 if you have the <gssapi.h> header file. */
/* #undef HAVE_GSSAPI_H */

/* Define to 1 if you have the `gss_init_sec_context' function. */
/* #undef HAVE_GSS_INIT_SEC_CONTEXT */ /* disabled for Quake3e */
...
/* #undef NE_HAVE_GSSAPI */ /* disabled for Quake3e */
